...
8. 已发生且仍待处理的质量、服务或配送投诉，且主要诉求是追责、升级投诉或需要人工
...
9. 已成立订单的物流、状态、退款审核或保修政策查询，如果没有反复推诿、承诺未履行、
   流程冲突等追责信号且已有可靠来源，应选择 answer 或 observe。
10. 顾客要办理实际退换修、退款或其他订单操作时，有已注册写工具且授权充分才选择 act；
...
15. 证据不足时直接选择 clarify；如果缺口无法通过当前只读工具消除，再选择 handoff。
